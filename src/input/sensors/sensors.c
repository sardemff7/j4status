...
{
    plugin->init   = _j4status_sensors_init;
    plugin->uninit = _j4status_sensors_uninit;

    plugin->get_sections = _j4status_sensors_get_sections;

    plugin->start = _j4status_sensors_start;
    plugin->stop  = _j4status_sensors_stop;
}
