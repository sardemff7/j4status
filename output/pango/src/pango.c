...
//#define COLOUR_STR(n) ColourStr n = { .start = { '<', 's', 'p', 'a', 'n', ' ', 'c', 'o', 'l', 'o', 'r', '=', '"', '#', 'F', 'F', 'F', 'F', 'F', 'F', 'F', 'F', '"', '>', '\0' }, .end = { '<', '/', 's', 'p', 'a', 'n', '>', '\0' } };
...
_j4status_pango_init(J4statusCoreInterface *core)
{
    ...
    if ( key_file != NULL )
    {
        ...
        _j4status_pango_update_colour(&context->colours.no_state, key_file, "NoStateColour");
        _j4status_pango_update_colour(&context->colours.unavailable, key_file, "UnavailableColour");
        _j4status_pango_update_colour(&context->colours.bad, key_file, "BadColour");
        _j4status_pango_update_colour(&context->colours.average, key_file, "AverageColour");
        _j4status_pango_update_colour(&context->colours.good, key_file, "GoodColour");
    }
