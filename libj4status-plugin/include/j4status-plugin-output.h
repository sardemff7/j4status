...
typedef gchar *(*J4statusPluginGenerateFunc)(J4statusPluginContext *context, GList *sections);
...
LIBJ4STATUS_PLUGIN_INTERFACE_ADD_CALLBACK(output, Output, generate, Generate);
