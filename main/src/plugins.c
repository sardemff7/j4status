...
#define PLUGINS_DATADIR J4STATUS_DATADIR G_DIR_SEPARATOR_S PACKAGE_NAME G_DIR_SEPARATOR_S "plugins"
#define PLUGINS_LIBDIR  J4STATUS_LIBDIR  G_DIR_SEPARATOR_S PACKAGE_NAME G_DIR_SEPARATOR_S "plugins"
